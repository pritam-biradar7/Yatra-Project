...
<h2 align="center" style="color:dodgerblue; font-family:times new roman; text-decoration: underline;text-shadow: 1px 1px grey;">Add New Package</h2>
...
<tr>	
	<td>
		<div class="form-group">
    		...
    		<input type="number" class="form-control" id="pAmt" name="pAmt">
		</div>
 	</td>
 </tr>
<tr>	
